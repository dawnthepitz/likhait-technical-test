...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const historyButtonStyle: React.CSSProperties = {
    ...navItemStyle,
    background: currentPage === "history" ? COLORS.primary.p02 : "transparent",
  };

  const categoriesButtonStyle: React.CSSProperties = {
    ...navItemStyle,
    background: currentPage === "categories" ? COLORS.primary.p02 : "transparent",
  };
